    ...
    <div className="w-full">
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-surface-container-lowest border-b border-outline-variant rounded-none">
        ...
        <button
          ...
          className="p-1.5 text-on-surface hover:text-accent transition-colors flex items-center justify-center rounded-lg"
        >
          <Menu size={24} />
        </button>
        ...
        >
          ...
          <span className="font-display-lg text-lg font-bold tracking-tight text-primary uppercase group-hover:text-accent transition-colors">
            Tokens Times
          </span>
        </div>
        ...
        <div className="md:hidden fixed inset-0 z-[100] bg-surface-container-lowest flex flex-col w-screen h-screen overflow-y-auto animate-fade-up">
          ...
          <div className="flex items-center justify-between px-4 py-3.5 border-b border-outline-variant shrink-0">
            ...
            <button
              ...
              className="p-2 text-on-surface hover:text-accent transition-colors flex items-center justify-center rounded-lg border border-outline-variant/60"
            >
            ...
            >
              <img alt="Token Times logo" className="w-7 h-7 shrink-0" src={logo} />
              <span className="font-display-lg text-lg font-bold tracking-tight text-primary uppercase">
                Tokens Times
              </span>
            </div>
          ...
          <div className="p-6 flex-grow flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <span className="font-label-caps text-xs text-accent font-bold uppercase tracking-widest block border-b border-outline-variant/40 pb-2">
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    ...
                    >
                      <span>{link}</span>
                      {isActive && (
                        <span className="flex items-center gap-2 text-xs text-accent font-bold">
                          ● ACTIVE
                        </span>
                      )}
                    </button>
            ...
            <div className="pt-4 border-t border-outline-variant/40 text-xs text-on-surface-variant space-y-2">
              <span className="font-label-caps text-[11px] font-bold text-accent block uppercase">
