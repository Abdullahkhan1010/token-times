...
export default function Published(articles, onArchive) {
  ...
  const columns = [
    ...
    { key: "views", label: "Views", render: (r) => <span className="font-data-tabular text-data-tabular">{r.view_count}</span> },
  ];
    ...
    <>
      ...
      <ArticleTable
        ...
        actions={[
          ...
          { label: "Move to archive", icon: Archive, onClick: articles.onArchive, tone: "error" },
        ]}
      />
    </>
  );
