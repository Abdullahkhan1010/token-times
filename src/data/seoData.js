...
export const PAGE_SEO_DATA = {
  ...
  Global: {
    title: "Global Web3 & Digital Asset Highlights | Token Times",
    description: "International market reporting, cross-border digital finance, and macro Web3 intelligence.",
    path: "/global",
    type: "website",
    schema: [SITE_ORGANIZATION_SCHEMA],
  },
  Features: {
    title: "Feature Stories & Special Reports | Token Times",
    description: "In-depth investigative reports, long-form journalism, and flagship digital asset features.",
    path: "/features",
    type: "website",
    schema: [SITE_ORGANIZATION_SCHEMA],
  },
  Markets: {
    title: "Digital Asset & Crypto Market Dashboards | Token Times",
    description: "Real-time crypto marketplace, forex exchange rates, and financial asset intelligence.",
    path: "/markets",
    type: "website",
    schema: [SITE_ORGANIZATION_SCHEMA],
  },
  "Policy & Regulation": {
    title: "Virtual Assets & Crypto Regulatory Tracker | Compliance & Law",
    description: "Track global and regional regulatory developments, FATF compliance standards, SECP frameworks, SBP guidelines, and tax legal updates.",
    path: "/regulations",
    type: "website",
    schema: [SITE_ORGANIZATION_SCHEMA],
  },
  ...
  Learn: {
    ...
    description: "Master virtual assets, blockchain protocols, zero-knowledge proofs, smart contract security, and compliance.",
    path: "/knowledge-hub",
    type: "website",
    schema: [SITE_ORGANIZATION_SCHEMA],
  },
